...
import com.sparkals.journalApp.service.WeatherService;
...
public ResponseEntity<?> updateUser(@RequestBody User user){
   ...
   String userName = authentication.getName();
    User useInDb = userService.findByUsername(userName);
        useInDb.setUserName(user.getUserName());
        useInDb.setPassword(user.getPassword());
        userService.saveNewUser(useInDb);
